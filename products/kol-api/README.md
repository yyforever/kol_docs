...
每个阶段产出一个核心文档，后一个依赖前一个。2026-03-20 起，`01-05` 口径从“独立售卖的 API 产品”切换为“聚星套餐内的 Skill 技能能力专题”。2026-05 起，Rest API 作为新的独立商业线重新启动，当前以 `09_Rest_API免费试用与自助增购PRD` 为主 PRD，`10_Rest_API开发者体验优化PRD` 承接李江反馈后的体验优化。
...
| [06_对外API免费试用方案](06_对外API免费试用方案.md) | Rest API 免费试用如何承接到月度订阅和大额 / 定制接口？ | 🟡 2026-05-28 v1.5 |
...
| [10_Rest_API开发者体验优化PRD](10_Rest_API开发者体验优化PRD.md) | 如何降低 Rest API 与 Skills 的理解混淆，并优化接口说明、文档和调试体验？ | 🟡 2026-06-22 v1.0 |
...
> 最新购买资格规则：免费试用和购买 Rest API 月度订阅都只要求主账号登录，不要求付费会员；子账号看不到 Rest API，也不能开通试用或购买。Rest API Credit 不是付费会员权益，也不和 Skill 次数混用。
> 最新价格规则：免费试用 `50 Credit`；月度订阅 `800 Credit / month`，国内 `1000 RMB / month`，海外 `180 USD / month`；Credit 每月重置，未使用 Credit 月末清零。`/product/pricing` 国内和海外都不展示 Rest API 价格。
