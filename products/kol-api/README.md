...
| 文档 | 核心问题 | 状态 |
|------|---------|:----:|
| [01_定位与假设](01_定位与假设.md) | 谁买？为什么买？为什么先做搜索/评估/监控？ | ✅ 定稿（2026-03-09） |
| [02_用户场景](02_用户场景.md) | 品牌广告主从发现到付费的完整旅程 | ✅ 定稿（2026-03-09） |
| [03_API能力设计](03_API能力设计.md) | Agent Tool 设计（Day 1 = discover/analyze/track/manage 只读） | ✅ 定稿（2026-03-09） |
| [04_定价与商业模式](04_定价与商业模式.md) | 怎么收钱？怎么防数据被低价拉走？ | ✅ 定稿（2026-03-09） |
| [05_PRD](05_PRD.md) | 工程团队拿到就能开工的文档 | ✅ **定稿 v1.1**（2026-03-09） |
...
- [x] **数据分级返回确认** ✅：普通搜索仅返回内部 `creator_id` 和不可外链摘要，外部可关联字段仅在 `analyze_creator` 暴露
- [x] **假粉检测方案** ✅：聚星已有三平台假粉检测能力，仅需适配统一接口
- [x] **全部决策项确认** ✅：品牌名、注册实体、首发平台、层级门控等全部落地
- [x] **PRD 定稿 v1.1** ✅：工程团队可以开工
