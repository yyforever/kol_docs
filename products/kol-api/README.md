...
| 文档 | 核心问题 | 状态 |
|------|---------|:----:|
| [01_定位与假设](01_定位与假设.md) | 谁买？为什么买？为什么先做搜索/评估/监控？ | ✅ 定稿（2026-03-10） |
| [02_用户场景](02_用户场景.md) | 品牌广告主从发现到付费的完整旅程 | ✅ 定稿（2026-03-10） |
| [03_API能力设计](03_API能力设计.md) | Agent Tool 设计（Day 1 = discover/analyze/track/manage 只读） | ✅ 定稿（2026-03-10） |
| [04_定价与商业模式](04_定价与商业模式.md) | 怎么收钱？怎么防数据被低价拉走？ | ✅ 定稿（2026-03-10） |
| [05_PRD](05_PRD.md) | 工程团队拿到就能开工的文档 | ✅ **定稿 v1.1**（2026-03-10） |
...
- [x] **定价风控口径确认** ✅：对外按 Credit 售卖，对内按 `creator / 维度 / 15 天` 的人民币 / 美元下限校验
