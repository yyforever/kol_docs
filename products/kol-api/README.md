...
| [03_API能力设计](03_API能力设计.md) | Agent Tool 设计（7 Tool + Credit 映射） | ✅ 初版完成（2026-02-12） |
| [04_定价与商业模式](04_定价与商业模式.md) | 怎么收钱？怎么防数据被搬？ | ✅ 初版完成（2026-02-12） |
| [05_PRD](05_PRD.md) | 工程团队拿到就能开工的文档 | ✅ 初版完成（2026-02-13） |
...
### 前置验证（开工前红线）
- [ ] **H4 聚星数据质量验证**：抽样 100 个欧美达人，对比 Modash/HypeAuditor 数据（覆盖率/新鲜度/准确度）
- [ ] **H1 需求验证**：最小 MCP/Skill 上线 ClawHub+Glama，观察安装量和使用频次

### Phase 1：场景与能力
- [ ] **品牌广告主使用旅程**：调研品牌在 Agent 平台中发现→启用→使用→付费的完整路径
- [ ] **能力清单确认**：哪些 Tool 必须有（P0），哪些可后续加
- [ ] **假粉检测方案**：评估 Phyllo 等供应商，确定 v1 方案
