...
- 安装或更新 CLI 后，运行 `noxinfluencer schema --all`。当前 CLI 基线需要覆盖 `login`、`campaign`、`collection`、`email`、`message`、`crm`、`product`、`short-link`、`affiliation`、`brand-monitor`、`export`、`feedback` 和 `agent`。
