...
1. Confirm account access and plan boundaries
2. Connect the relevant skill or capability layer inside Claude
3. Start with discovery before moving into deep evaluation
