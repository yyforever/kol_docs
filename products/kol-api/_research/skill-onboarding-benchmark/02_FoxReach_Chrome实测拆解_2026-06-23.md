...
1. 拆 Amplemarket Skills，重点看 skill / play 命名和非技术用户文案。
2. 拆 Twenty CRM MCP，重点看 object handoff、workspace records 和 developer docs。
3. 横向比较 Seamless.AI 与 FoxReach：Seamless 更适合 business outcome / persona 分流参考，FoxReach 更适合 OAuth-first / agent runtime quick start / SaaS state machine 参考。
